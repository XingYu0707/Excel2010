...
public class Clientshowsele {
	...
	public static String jumpsele() throws SQLException {
		list2 = new ArrayList<Assign>();
		System.out.println("JDBCsql.checknamedate(name,date)="
				+ JDBCsql.checknamedate(name, date));
		if (JDBCsql.checknamedate(name, date) == false) {
		...
		opennumDI = bug1opennumDI + (double) bug2opennumDI
				+ (double) bug3opennumDI + (double) bug4opennumDI;
		weekclosenumDI = bug1weekclosenumDI + (double) bug2weekclosenumDI
				+ (double) bug3weekclosenumDI + (double) bug4weekclosenumDI;
		weekopennumDI = bug1weekopennumDI + (double) bug2weekopennumDI
				+ (double) bug3weekopennumDI + (double) bug4weekopennumDI;
		closenumDI = bug1closenumDI + (double) bug2closenumDI
				+ (double) bug3closenumDI + (double) bug4closenumDI;
		allnumDI = bug1allnumDI + (double) bug2allnumDI + (double) bug3allnumDI
				+ (double) bug4allnumDI;
		project = JDBCshow.checkproject(name, date);
		System.out.println(bug1weekclosenum + "   "
				+ (double) bug2weekclosenumDI + "   "
				+ (double) bug3weekclosenumDI + "   "
				+ (double) bug4weekclosenumDI);
		...
		/*System.out.println(Method.getsesslist().get(0).toString() + "  "
				+ Method.getsesslist().get(1).toString());*/
